...
(function ($) {
  $(document).ready(function() {
    ...
    window.index.add({
      ...
      body: 'Quase todos os aplicativos Markdown suportam a sintaxe básica descrita no documento de design original de John Gruber. Existem pequenas variações e discrepâncias entre os processadores Markdown - essas são anotadas em linha sempre que possível.'
    });
    ...
    window.index.add({
      href: 'https://markdown.net.br/folha-de-dicas/',
      title: 'Folha de Dicas, Consulta Rápida',
    ...
    $('input#search').on('keyup', debounce(function (e) {
      ...
      var results = window.index.search(query).slice(0, 6).map(function (result) {
        ...
        href = href.trimRight("/");
        href = href.replace("/", ' <i class="fas fa-arrow-right" style="margin: 0 5px;color: #989898;"></i> ')
